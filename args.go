...
var args = arguments{
	...
	Modules: flag.String(
		...
		commentsWithDefaults("The list of modules to load, separated by ','",
			"(valid choices: aws, bzr, cwd, docker, docker-context, dotenv, duration, exit, fib, fossil, gcp, git, gitlite, goenv, hg, host, jobs, kube, load, newline, nix-shell, node, perlbrew, perms, plenv, rbenv, root, shell-var, shenv, ssh, svn, termtitle, terraform-workspace, time, user, venv, vgo, wsl)",
